...
//	wp_enqueue_style( 'pw-select2-field-mods', PW_SELECT2_URL . 'css/select2.css', array(), PW_SELECT2_VERSION );
	...
	wp_enqueue_script( 'pw-select2-field-js', plugins_url('/js/select2/select2.min.js', dirname(__FILE__) ), array( 'jquery-ui-sortable' ), '3.5.1' );
	wp_enqueue_script( 'pw-select2-field-init', plugins_url('/js/select2-init.js', dirname(__FILE__) ), array( 'pw-select2-field-js' ), PW_SELECT2_VERSION );
	wp_enqueue_style( 'pw-select2-field-css', plugins_url('/js/select2/select2.css', dirname(__FILE__) ), array(), '3.5.1' );
	wp_enqueue_style( 'pw-select2-field-mods', plugins_url('/css/select2.css', dirname(__FILE__) ), array(), PW_SELECT2_VERSION );
}
